  ...
  render(){
    ...
    return(
      <div style={{height: "100%"}}>
        ...
        <div style={{paddingTop:'2vw',height: "100%", overflowY: "scroll"}}>
              ...
              <Card style={{width:"auto"}}>
                <Card.Body>
                  ...
                  <div className="d-flex justify-content-start">
                    {this.state.mediaID && <MediaEmbed mwidth="37vw" targetMediaID={this.state.mediaID} />}
                  </div>
                  ...
                  <div style={{paddingTop:"0.5vw"}}>
                    {this.state.comments[0] && this.state.comments.map((com, index) => {
                      return (
                        <div style={{margin:"0"}} key={`com_${index}`}>
                          {' '}
                          <Comment id={com.userID} comment={com.comment} timestamps={com.timestamps} />
                        </div>
                      )
                    })}
                  </div>
